...
exports.run = async (client, message, args) => {
    ...
    if (message.author.id !== "214651290234388480") return message.reply("This is a developer only command.");
    ...
    let embed = new Discord.RichEmbed()
        .setAuthor("Reload Successful!", "https://mxpez29397.i.lithium.com/html/images/emoticons/2705.png")
